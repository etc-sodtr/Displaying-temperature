...
/* The class Core::KeyPressHandler provides a universal keyboard event handler able 
   ...
   sends signals to the slot methods stored in the @OnPress and @OnRelease properties.
   ...
   editting the GUI component. If necessary several keyboard handlers can be added 
