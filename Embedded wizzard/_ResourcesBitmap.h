...
/* The class Resources::Bitmap provides the base functionality to handle bitmaps. 
   ...
   bitmaps are very usefull e.g. to run short video sequences.
   ...
   Embedded Wizard Gallery into the Composer window where you are editting your 
   GUI project. The bitmap attributes will be determined in the Embedded Wizard 
   Inspector. */
