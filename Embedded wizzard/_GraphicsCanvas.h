...
/* The class Graphics::Canvas provides a drawing destination for all graphics operations. 
   ...
   Since the canvas inherites from the Resources::Bitmap class it can be handled 
   ...
   Only in some few cases, if you plan to develop your own primite view classes 
   you probably will need to invoke this class methods in order to draw you view. */
