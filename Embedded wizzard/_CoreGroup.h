...
/* The class Core::Group provides the base functionality for all kinds of complex 
   ...
   exsting views from the group or to change the so-called Z-order of views - the 
   ...
   be animated - it can avoid superflous redrawing of the groups content. Other 
   ...
   of the group aspect can be shown on the screen. Useful for many fadeing, 2D/3D 
   warping or mirroring visual effects.
